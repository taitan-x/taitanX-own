...
YOUR_GROUP = getenv("YOUR_GROUP", "https://t.me/world_music_masti")

YOUR_CHANNEL = getenv("YOUR_CHANNEL", "https://t.me/taitanoffice")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/taitan-x/taitanX-own",
)
