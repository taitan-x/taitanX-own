...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("world_music_masti")
                await self.one.join_chat("Taitanoffice")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("worl_music_masti")
                await self.two.join_chat("taitanoffice")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("world_music_masti")
                await self.three.join_chat("Taitanoffice")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("world_music_masti")
                await self.four.join_chat("taitanoffice")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("world_music_masti")
                await self.five.join_chat("taitanoffice")
            except:
                pass
            assistants.append(5)
